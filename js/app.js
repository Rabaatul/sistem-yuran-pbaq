...
// Master List 39 Murid FQC Default
const MASTER_STUDENTS_DEFAULT = [
  ...
  { id: 4, nama: "Muhammad Irfan Shafie Bin Kamarul", phone: "0196959040" },
  { id: 5, nama: "Muhammad Harith Bin Muhamad Hosni", phone: "0193332054" },
  { id: 6, nama: "Nik Mus’ab Az-Zhafran Bin Ahmad Faidhul Irfan", phone: "0133484008" },
  { id: 7, nama: "Muhammad Zayyan Nawfal Bin Shahrul Azmi", phone: "0192826203" },
  { id: 8, nama: "Fadhil Lutfi Bin Ali Imran", phone: "0123647289" },
  { id: 9, nama: "Syahira Aneesa Binti Ahmad Radzi", phone: "0192885947" },
  { id: 10, nama: "Abdul Aziz Bin Mohd Razali", phone: "0173184593" },
  { id: 11, nama: "Tengku Aqill Hafy Bin Tengku Shahrizal", phone: "0179042049" },
  { id: 12, nama: "Aisyahtul Aufa Raihanah Binti Mohd Riduan", phone: "0126224611" },
  { id: 13, nama: "Muhammad Ainul Mubarok Asy’ari Bin Kosim", phone: "0133943310" },
  { id: 14, nama: "Nur Qisya Damia Binti Mohamad Khairi", phone: "0162912079" },
  { id: 15, nama: "Muhammad Al Fateh Bin Mohd Firdaus", phone: "0126063578" },
  { id: 16, nama: "Muhammad Syauqi Bin Norsyam", phone: "0176840534" },
  { id: 17, nama: "Nur Sarah Ardhilya Binti Mohd Sufian", phone: "0123606852" },
  { id: 18, nama: "Alya Sofia Binti Aris", phone: "0173235786" },
  { id: 19, nama: "Muhammad Adam Rizq Bin Muhammad Jazuli", phone: "01110340606" },
  { id: 20, nama: "Muhammad Saeed Bin Muhammad Ridhwan", phone: "0129220073" },
  { id: 21, nama: "Maryam Sumayyah Binti Muhammad Javed Butt", phone: "0109294407" },
  { id: 22, nama: "Wan Anaqi Ziqri Bin Wan Sulaiman", phone: "0197751085" },
  { id: 23, nama: "Muhammad Darwisy Haikal Bin Muhammad Ellias", phone: "0126362359" },
  { id: 24, nama: "Muhammad Nur Firash Bin Muhammad Nur Fitri", phone: "0122528736" },
  { id: 25, nama: "Shafy Baaqir Bin Shahrul Nizam", phone: "0166247850" },
  { id: 26, nama: "Nur Amni Syuhada Binti Mohd Nor Safuan", phone: "0163819439" },
  { id: 27, nama: "Hani Sofia Binti Mohd Afwaz", phone: "0126765247" },
  { id: 28, nama: "Arissa Medina Binti Ahmad Fauzi", phone: "0129425926" },
  { id: 29, nama: "Muhammad Rizal Arshad Bin Mohd Rosmizam", phone: "0129343676" },
  { id: 30, nama: "Ainan Salsabila Binti Hafiz Anuar", phone: "0139311818" },
  { id: 31, nama: "Ammar Rifqi Bin Apandi", phone: "0129324167" },
  { id: 32, nama: "Rayyan Kalif Bin Rafizi", phone: "0134471546" },
  { id: 33, nama: "Muhammad Eizzuddin", phone: "0196804101 / 0196493646" },
  { id: 34, nama: "Muhammad Aqil Raziq Bin Zul Azlan", phone: "0123038634" },
  { id: 35, nama: "Che Aqil Rayqal Bin Hafizul Ariffin", phone: "0126648853" },
  { id: 36, nama: "Muhammad Aryan Ziqri Bin Md Zahid", phone: "0193853222" },
  { id: 37, nama: "Muhammad Al Hafiz Bin Mohd Zin", phone: "0192248326" },
  { id: 38, nama: "NAJIHAH", phone: "0134565245" },
...
function renderDashboard() {
  ...
  const totalMurid = appState.students.length;
  const totalResit = appState.payments.length;
  ...
  if (document.getElementById("dash-total-murid")) document.getElementById("dash-total-murid").innerText = totalMurid;
  if (document.getElementById("dash-total-resit")) document.getElementById("dash-total-resit").innerText = totalResit;
}
...
async function fetchStudentsFromBackend(showToastMsg = false) {
  ...
  try {
    if (showToastMsg) showLoading(true, "Memuat turun data murid...");
    ...
    if (data.success && Array.isArray(data.data) && data.data.length > 0) {
      ...
      initStudentSearch();
      if (showToastMsg) showToast(`Senarai ${appState.students.length} murid dikemaskini!`, "success");
    }
  } catch (err) {
