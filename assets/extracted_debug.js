...
// --- FUNGSI CETAK RESIT (IFRAME DEDICATED - EXACT 1 PAGE A4 RESIT SAHAJA) ---
function actionCetakResit() {
  try {
    ...
    doc.write(`
      ...
      <html>
      <head>
        <title>Resit Pembayaran - Fathul Quranic Centre (NS0326067-A)</title>
        ...
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .receipt-header { display: flex; align-items: center; justify-content: space-between; border-bottom: 2px solid #2e7d32; padding-bottom: 0.75rem; margin-bottom: 0.75rem; }
          .receipt-header-left { display: flex; align-items: center; gap: 0.75rem; }
          .receipt-logo { width: 52px; height: 52px; object-fit: contain; }
          .receipt-centre-title { font-size: 1.05rem; font-weight: 800; color: #1b4d2e; line-height: 1.2; }
          .receipt-centre-address { font-size: 0.68rem; color: #64748b; margin-top: 2px; max-width: 320px; }
          .receipt-title-badge { text-align: right; }
          .receipt-title-badge h2 { font-size: 1.15rem; font-weight: 800; color: #1b4d2e; margin: 0; }
          .receipt-no-tag { font-size: 0.78rem; font-weight: 700; color: #2e7d32; background: #e8f5e9; padding: 0.15rem 0.5rem; border-radius: 4px; display: inline-block; margin-top: 3px; }
          .receipt-meta-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.6rem; margin-bottom: 0.75rem; background: #f8fafc; padding: 0.65rem 0.85rem; border-radius: 6px; font-size: 0.8rem; border: 1px solid #e2e8f0; }
          ...
          .receipt-table { width: 100%; border-collapse: collapse; margin-bottom: 0.85rem; font-size: 0.8rem; }
          .receipt-table th { background: #1b4d2e; color: #ffffff; padding: 0.5rem 0.7rem; font-weight: 700; text-align: left; }
          .receipt-table td { padding: 0.5rem 0.7rem; border-bottom: 1px solid #e2e8f0; }
          .receipt-table tr.active-item { font-weight: 600; }
          .receipt-table .amount-cell { text-align: right; font-weight: 700; }
          .receipt-footer-section { display: flex; justify-content: space-between; align-items: flex-end; margin-top: 0.85rem; padding-top: 0.75rem; border-top: 1px solid #e2e8f0; }
          .receipt-signature-box { text-align: center; }
          .receipt-signature-img { height: 42px; object-fit: contain; margin-bottom: 2px; }
          .receipt-signature-title { font-size: 0.68rem; font-weight: 700; color: #64748b; border-top: 1px dashed #64748b; padding-top: 3px; }
          .receipt-total-box { text-align: right; }
          .receipt-total-label { font-size: 0.78rem; font-weight: 700; color: #64748b; }
          .receipt-total-value { font-size: 1.4rem; font-weight: 800; color: #1b4d2e; }
        </style>
      </head>
      <body>
        ${receiptHtml}
